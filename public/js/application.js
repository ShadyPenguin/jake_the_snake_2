...
$(document).ready(function() {
  ...
  // $('body').on('submit', '#create_user', function(e) {
  //   e.preventDefault();
  //   data = $('#create_user').serialize();
  //   console.log(data);
  //   $.post('/create_user', data, function(resposne) {
  //     console.log(response);
  //   })
  // })

  // $('#a_create').on('click', function(e) {
  //   e.preventDefault();
  //   $.get('/create_user', function(response) {
  //     $('body').html(response);
  //   })
  // });
